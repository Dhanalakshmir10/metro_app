...
public class Graph_M {
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			g.addVertex("Attiguppe 62~B");
			g.addVertex("Baiyappanahalli~B");
			g.addVertex("Banashankari~B");
			g.addVertex("Krantivira Sangolli Rayanna Railway Station~BY");
			g.addVertex("Chickpete~B");
			g.addVertex("Cubbon Park~B");
			g.addVertex("Dasarahalli~BO");
			g.addVertex("Goraguntepalya 21~B");
			g.addVertex("Indiranagar~Y");
			g.addVertex("Jalahalli~Y");
			g.addVertex("Jayanagar~Y");
			g.addVertex("jayaprakashnagar~Y");
			g.addVertex("Jnanabharati~YO");
			g.addVertex("kengeri~Y");
			g.addVertex("Lalbagh~O");
			g.addVertex("Magadi Road~O");
			g.addVertex("Nagasandra~O");
			g.addVertex("Peenya~BP");
			g.addVertex("Mantri square sampige road~PR");
			g.addVertex("Whitefield~P");
			
			g.addEdge("Attiguppe 62~B","Baiyappanahalli~B", 8);
			g.addEdge("Baiyappanahalli~B", "Banashankari~B", 10);
			g.addEdge("Banashankari~B", "Krantivira Sangolli Rayanna Railway Station~BY", 8);
			g.addEdge("Krantivira Sangolli Rayanna Railway Station~BY","Chickpete~B", 6);
			g.addEdge("Chickpete~B", "Cubbon Park~B", 9);
			g.addEdge("Cubbon Park~B", "Dasarahalli~BO", 7);
			g.addEdge("Dasarahalli~BO", "Goraguntepalya 21~B", 6);
			g.addEdge("Goraguntepalya 21~B", "Indiranagar~Y", 15);
			g.addEdge("Indiranagar~Y", "Jalahalli~Y", 6);
			g.addEdge("Jalahalli~Y", "Jayanagar~Y", 7);
			g.addEdge("Jayanagar~Y", "jayaprakashnagar~Y", 1);
			g.addEdge("jayaprakashnagar~Y","Jnanabharati~YO", 2);
			g.addEdge("Jnanabharati~YO","kengeri~Y", 5);
			g.addEdge("kengeri~Y","Lalbagh~O", 2);
			g.addEdge("Lalbagh~O", "Magadi Road~O", 7);
			g.addEdge("Magadi Road~O", "Nagasandra~O", 8);
			g.addEdge("Nagasandra~O", "Peenya~BP", 2);
			g.addEdge( "Peenya~BP", "Mantri square sampige road~PR", 2);
			g.addEdge("Mantri square sampige road~PR", "Whitefield~P", 3);
		}
